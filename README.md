...
**Атрибуты**: уникальный идентификатор, название, описание, срок действия в днях, количество посещений (или безлимит), стоимость, применяется ко всем занятиям (флаг), список разрешенных типов занятий (если не ко всем).  
